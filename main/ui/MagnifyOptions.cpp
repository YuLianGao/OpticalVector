    ...
    ui(new Ui::MagnifyOptions)
{
    ...
    connect(ui->checkBox, SIGNAL(clicked()), SLOT(updateFlagsFromOptionsTab()));
    connect(ui->checkBox, SIGNAL(clicked()), SLOT(upadateRotationValue()));
    connect(ui->RotationSpinBox, SIGNAL(valueChanged(int)), SLOT(upadateRotationValue()));
    connect(ui->RotationSpinBox, SIGNAL(valueChanged(int)), SLOT(updateSettingsFromOptionsTab()));
...
{    
    ...
    else if(imgProcFlags.rotateOn) {
        if(sender() == ui->RotationSpinBox)
            ui->RotationSpinBox->setValue(static_cast<int>(val));
    }
}
...
void MagnifyOptions::reset()
{
    ...
    case 3:
        ...
        ui->RotationSpinBox->setValue(this->imgProcSettings.rotationValue);
    ...
    default:  
        ...
        ui->RotationSpinBox->setDisabled(false);
...
void MagnifyOptions::updateFlagsFromOptionsTab()
{
    ...
    imgProcFlags.rotateOn = ui->checkBox->isChecked();
...
void MagnifyOptions::upadateRotationValue(void)
{
    imgProcSettings.rotationValue = ui->RotationSpinBox->value();
      qDebug() << "MagnifyOptions::upadateRotationValue(void) imgProcSettings.rotationValue =" << imgProcSettings.rotationValue;
}
