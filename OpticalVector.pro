...
win32 {
    ...
    CONFIG(release, debug|release) {
        LIBS += $$PWD\external\opencv\build\x64\vc15\lib\opencv_world412.lib
        #LIBS += F:\Programme\opencv-4.1.2\build\install\x64\vc15\lib\opencv_highgui412.lib
        #LIBS += F:\Programme\opencv-4.1.2\build\install\x64\vc15\lib\opencv_imgproc412.lib
        #LIBS += F:\Programme\opencv-4.1.2\build\install\x64\vc15\lib\opencv_imgcodecs412.lib
        #LIBS += F:\Programme\opencv-4.1.2\build\install\x64\vc15\lib\opencv_videoio412.lib
        #LIBS += F:\Programme\opencv-4.1.2\build\install\x64\vc15\lib\opencv_video412.lib
        #LIBS += D:\Programme\OpenCV\source\tbb2019_20190605oss\lib\intel64\vc14\tbb.lib
    }
    CONFIG(debug, debug|release) {
        DEFINES += DEBUG_MODE
        LIBS += $$PWD\external\opencv\build\x64\vc15\lib\opencv_world412d.lib
        #LIBS += F:\Programme\opencv-4.1.2\build\install\x64\vc15\lib\opencv_highgui412d.lib
        #LIBS += F:\Programme\opencv-4.1.2\build\install\x64\vc15\lib\opencv_imgproc412d.lib
        #LIBS += F:\Programme\opencv-4.1.2\build\install\x64\vc15\lib\opencv_imgcodecs412d.lib
        #LIBS += F:\Programme\opencv-4.1.2\build\install\x64\vc15\lib\opencv_videoio412d.lib
        #LIBS += F:\Programme\opencv-4.1.2\build\install\x64\vc15\lib\opencv_video412d.lib
       # LIBS += D:\Programme\OpenCV\source\tbb2019_20190605oss\lib\intel64\vc14\tbb_debug.lib
    }
    LIBS += -L"$$PWD/external/opencv/build/x64/vc15/bin"
    # !! Change this to match your OpenCV (>= v4) installation on Windows !! #
    ##########################################################################
...
DEPENDPATH += $$PWD/lib  $$PWD/qmake/staticlib/jkqtplotterlib
INCLUDEPATH += $$PWD/lib
CONFIG (debug, debug|release) {
    LIBS += -L$$PWD/qmake/staticlib/jkqtplotterlib/debug -ljkqtplotterlib_debug
} else {
    LIBS += -L$$PWD/qmake/staticlib/jkqtplotterlib/release -ljkqtplotterlib
}
message("LIBS = $$LIBS")
